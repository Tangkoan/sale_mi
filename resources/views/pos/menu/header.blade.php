...
<div x-data="headerController()" x-init="init()" class="contents">
    ...
    {{-- MAIN HEADER BAR --}}
    <div class="z-30 shrink-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 shadow-sm sticky top-0">
        <div class="px-3 py-2 sm:px-4 sm:py-3 flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                {{-- A. OPERATIONAL BUTTONS --}}
                <div class="flex items-center gap-2">
                    {{-- Exchange Rate --}}
                    <button @click="openExchangeModal()" class="flex items-center justify-center w-9 h-9 rounded-full bg-emerald-50 text-emerald-600 hover:bg-emerald-100 dark:bg-emerald-900/30 dark:text-emerald-400 transition relative group border border-emerald-100 dark:border-emerald-800">
                    ...
                    <button @click="toggleAddonMode()" 
                            ...
                            :class="isAddonMode ? 'bg-purple-600 text-white shadow-lg shadow-purple-500/30' : 'bg-purple-50 text-purple-700 hover:bg-purple-100 dark:bg-purple-900/20 dark:text-purple-300 border border-purple-100 dark:border-purple-800'">
                    ...
                    {{-- Search Toggle --}}
                    <button @click="toggleSearch()" class="flex-shrink-0 w-9 h-9 rounded-full border flex items-center justify-center transition-all" 
                            :class="isSearchOpen ? 'bg-primary text-white border-primary' : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-50'">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" @click.away="open = false" 
                            ...
                            <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name ?? 'Staff' }}&background=0D8ABC&color=fff&size=64" 
        ...
        {{-- Search Bar --}}
        <div x-show="isSearchOpen" x-transition class="px-3 sm:px-4 pb-2 sm:pb-3 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md">
            <div class="relative">
        ...
        {{-- CATEGORY TABS --}}
        @if(isset($categories))
        <div class="px-3 sm:px-4 pb-2 sm:pb-3 overflow-x-auto no-scrollbar flex gap-2 sm:gap-3 snap-x bg-white/90 dark:bg-gray-900/90 backdrop-blur-md">
