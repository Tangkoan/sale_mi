{{-- សម្គាល់៖ លែងមាន x-data នៅទីនេះទៀតហើយ វាប្រើរបស់មេ (posTables) វិញ --}}
        ...
        <div class="flex flex-col h-[45%] md:h-full md:flex-[1.5] border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 relative">
            ...
            <div class="p-4 md:p-5 border-b border-gray-100 dark:border-gray-700 shrink-0 flex justify-between items-center bg-white dark:bg-gray-800 z-10">
                <div>
                    ...
                    {{-- ប្រើ template x-if ការពារ Error --}}
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-0.5">
                                        <button @click="updateItemQty(item.id, 'decrease')" class="w-7 h-7 flex items-center justify-center rounded-md bg-white dark:bg-gray-600 text-gray-600 dark:text-white shadow-sm hover:text-red-500">
                                        ...
                                        <button @click="updateItemQty(item.id, 'increase')" class="w-7 h-7 flex items-center justify-center rounded-md bg-white dark:bg-gray-600 text-blue-600 dark:text-blue-400 shadow-sm hover:bg-blue-50">
